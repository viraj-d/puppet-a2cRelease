/*
* Kendo UI v2014.3.1328 (http://www.telerik.com/kendo-ui)
    ...
    var Scheduler = DataBoundWidget.extend({
        ...
        _select: function() {
         ...
         /*customization starts here */
                ...
                var x = $("div[data-uid='" + selecteduid + "']").length;
                var className = '';
                if (x > 0) {
                    className = $("div[data-uid='" + selecteduid + "']")[0].className;
                    if (className.indexOf('k-state-selected') > 0) {
                        $($("div[data-uid='" + selecteduid + "']")[0])
                            .removeAttr("id")
        ...
        _updateSelection: function(dataItem, events) {
            ...
            /*customization starts here */
            selecteduid = selection.events[0];
            /*customization ends here */
        },
