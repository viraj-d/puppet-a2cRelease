...
GO
PRINT N'Altering [dbo].[usp_EDINotification]...';


GO

ALTER PROCEDURE [dbo].[usp_EDINotification]
@SchoolId int,
...
BEGIN
	...
	SELECT	AOC.[CentreId], aoc.AwardingOrganisationCentreId as AwardingOrganisationCentreId, ACI.AOAssignCentreNumber + ' (AO Assigned)' CentreNumber
...
END
GO
PRINT N'Creating [dbo].[usp_GetTransactionResponseEnvelopeEDI]...';
...
CREATE  PROCEDURE [dbo].[usp_GetTransactionResponseEnvelopeEDI]
@SchoolId int,
...
Begin
	...
	SELECT [A2CTransactionResponseEnvelopeEDIId], [AwardingOrganisationCentreId], [A2CTransactionResponseEnvelopeId], [data], [FileName], [SchoolID] AS A2CSchoolId 
    FROM [dbo].[A2CTransactionResponseEnvelopeEDIs]
	WHERE [SchoolID] = @SchoolId AND [A2CTransactionResponseEnvelopeEDIId] = @TransactionResponseEnvelopeEdiId 
...
GO
EXECUTE sp_updateextendedproperty @name = N'Version', @value = N'15.1.10.3';
